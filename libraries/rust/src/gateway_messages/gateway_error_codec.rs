...
pub use decoder::GatewayErrorDecoder;
pub use encoder::GatewayErrorEncoder;
...
pub mod encoder {
    ...
    pub struct GatewayErrorEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for GatewayErrorEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for GatewayErrorEncoder<'a> {
        #[inline]
    ...
    impl<'a> GatewayErrorEncoder<'a> {
        ...
        /// VAR_DATA ENCODER - character encoding: 'UTF-8'
        #[inline]
        pub fn message(&mut self, value: &str) {
            let limit = self.get_limit();
            let data_length = value.len();
            self.set_limit(limit + 4 + data_length);
            self.get_buf_mut().put_u32_at(limit, data_length as u32);
...
pub mod decoder {
    ...
    pub struct GatewayErrorDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for GatewayErrorDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for GatewayErrorDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for GatewayErrorDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
