...
pub use decoder::GatewayStreamUpdateDecoder;
pub use encoder::GatewayStreamUpdateEncoder;
...
pub mod encoder {
    ...
    pub struct GatewayStreamUpdateEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for GatewayStreamUpdateEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for GatewayStreamUpdateEncoder<'a> {
        #[inline]
    ...
    impl<'a> GatewayStreamUpdateEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn event_type(&mut self, value: update_event_type::UpdateEventType) {
...
pub mod decoder {
    ...
    pub struct GatewayStreamUpdateDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for GatewayStreamUpdateDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for GatewayStreamUpdateDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for GatewayStreamUpdateDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> GatewayStreamUpdateDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn event_type(&self) -> update_event_type::UpdateEventType {
