...
pub use decoder::GatewayStatsDecoder;
pub use encoder::GatewayStatsEncoder;
...
pub mod encoder {
    ...
    pub struct GatewayStatsEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for GatewayStatsEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for GatewayStatsEncoder<'a> {
        #[inline]
    ...
    impl<'a, P> StatsEncoder<P> where P: Encoder<'a> + Default {
        ...
        /// - version: 0
        #[inline]
        pub fn added_count(&mut self, value: i64) {
            let offset = self.offset;
            self.get_buf_mut().put_i64_at(offset, value);
        }

        /// primitive field 'removedCount'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn removed_count(&mut self, value: i64) {
            let offset = self.offset + 8;
            self.get_buf_mut().put_i64_at(offset, value);
        }

        /// primitive field 'clearedCount'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn cleared_count(&mut self, value: i64) {
...
pub mod decoder {
    ...
    pub struct GatewayStatsDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for GatewayStatsDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for GatewayStatsDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for GatewayStatsDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> GatewayStatsDecoder<'a> {
        ...
        /// GROUP DECODER (id=20)
        #[inline]
        pub fn stats_decoder(self) -> StatsDecoder<Self> {
            StatsDecoder::default().wrap(self)
        }
