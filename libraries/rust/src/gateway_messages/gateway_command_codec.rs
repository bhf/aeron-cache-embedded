...
pub use decoder::GatewayCommandDecoder;
pub use encoder::GatewayCommandEncoder;
...
pub mod encoder {
    ...
    pub struct GatewayCommandEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for GatewayCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for GatewayCommandEncoder<'a> {
        #[inline]
    ...
    impl<'a> GatewayCommandEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn msg_type(&mut self, value: u16) {
        ...
        /// - version: 0
        #[inline]
        pub fn ttl(&mut self, value: i64) {
            let offset = self.offset + 2;
            self.get_buf_mut().put_i64_at(offset, value);
        }

        /// primitive field 'counterValue'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808
        /// - characterEncoding: null
...
pub mod decoder {
    ...
    pub struct GatewayCommandDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for GatewayCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for GatewayCommandDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for GatewayCommandDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> GatewayCommandDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
