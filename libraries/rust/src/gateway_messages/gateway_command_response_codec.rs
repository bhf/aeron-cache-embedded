...
pub use decoder::GatewayCommandResponseDecoder;
pub use encoder::GatewayCommandResponseEncoder;
...
pub mod encoder {
    ...
    pub struct GatewayCommandResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for GatewayCommandResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for GatewayCommandResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> GatewayCommandResponseEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct GatewayCommandResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for GatewayCommandResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for GatewayCommandResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for GatewayCommandResponseDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> GatewayCommandResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
