...
pub use decoder::GatewayUnsubscribeDecoder;
pub use encoder::GatewayUnsubscribeEncoder;
...
pub mod encoder {
    ...
    pub struct GatewayUnsubscribeEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for GatewayUnsubscribeEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for GatewayUnsubscribeEncoder<'a> {
        #[inline]
    ...
    impl<'a> GatewayUnsubscribeEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct GatewayUnsubscribeDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for GatewayUnsubscribeDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for GatewayUnsubscribeDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for GatewayUnsubscribeDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> GatewayUnsubscribeDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
